[![npm version](https://img.shields.io/npm/v/@z-base/gqes)](https://www.npmjs.com/package/@z-base/gqes)
[![CI](https://github.com/z-base/gqes/actions/workflows/ci.yaml/badge.svg?branch=master)](https://github.com/z-base/gqes/actions/workflows/ci.yaml)
[![codecov](https://codecov.io/gh/z-base/gqes/branch/master/graph/badge.svg)](https://codecov.io/gh/z-base/gqes)
[![license](https://img.shields.io/npm/l/@z-base/gqes)](LICENSE)
...
Globally Qualified Electronic Seals / Signatures

what it's for

digital signatures that need recognition from a covernance
the hope is to identify and define widely available hardware, firmware, operating system, and software components that fulfill the requirements of EU Legislation leading to global inter operability and decentralization of trust services and
